...
start "Customer-App" cmd /k "cd /d %PROJECT_ROOT%customer-app && set NODE_OPTIONS=--openssl-legacy-provider && npx expo start --port 8081 --lan"

rem ---- Terminal 3 – Mechanic Expo on port 8082 ----
start "Mechanic-App" cmd /k "cd /d %PROJECT_ROOT%mechanic-app && set NODE_OPTIONS=--openssl-legacy-provider && npx expo start --port 8082 --lan"
