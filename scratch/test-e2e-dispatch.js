...
async function runE2ETest() {
  ...
  try {
    ...
    console.log(`[TRACE Step 1 Server Status Toggle] Mechanic ${verifiedMech._id} status updated in MongoDB to isOnline: ${verifiedMech.isOnline}, status: ${verifiedMech.status}, location:`, verifiedMech.location);
    ...
    const dispatchService = require('../backend/services/dispatchService');
